...
public class CodeGenerateUtils {
     ...
     * 代码生成位置
     */
    public static final String PARENT_NAME = "com.neuedu.lishuailong.skilltrain";
     ...
     * 作者
     */
    public static final String AUTHOR = "Lishuailong";
    ...
    public static final String JDBC_MYSQL_URL = "jdbc:mysql://127.0.0.1:3306/skilldb?" +
    ...
    public static final String JDBC_PASSWORD = "bilibili1314";
    ...
    private static InjectionConfig getInjectionConfig(final String moduleName) {
        return new InjectionConfig() {
            ...
            public void initMap() {
                ...
                setMap(map);
                final String projectPath = "D:\\ideawork\\skilltrain";
                ...
                fileOutConfigList.add(new FileOutConfig("/templates/mapper.xml.vm") {
                    ...
                    public String outputFile(TableInfo tableInfo) {
                        ...
                        //return projectPath + "/src/main/java/mapper/xml/" +
    ...
    private static GlobalConfig getGlobalConfig() {
        ...
        String projectPath = "D:\\ideawork\\skilltrain";
